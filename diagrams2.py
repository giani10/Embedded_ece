...
# The CSV should have columns "Timestamp" and "TimeDiff".
...
# Option 2: Alternatively, if you want to plot all data points, comment out the resampling.
# timing_resampled = timing
